...
?>
<div
    class="gazelle-product"
    data-product-id="<?php echo esc_attr($product_id); ?>"
    data-variations='<?php echo wp_json_encode($available_variations); ?>'
        ...
        <div class="col-lg-5">
            ...
            <?php
                ...
                <h3 class="menu-detail-price">
                    &euro; <span class="gazelle-product-price">
                ...
                <?php if ($product && $product->is_type('variable') && ! empty($sizes)) : ?>
                   ...
                   <script>
                    ...
                    <p class="mb-1">
                        <?php echo wc_attribute_label($attribute_key); ?>
                    </p>
            ...
            <form >
                <div class="quantity quantity-lg">
                    ...
                    <input 
                       type="numnber" 
                       class="input-text qty text gazelle-quantity" 
                       title="Qty" 
                       value="1"
                       name="quantity" min="1" step="1">
                    <input type="button" class="plus text-color-hover-light bg-color-hover-primary border-color-hover-primary" value="+">
                </div>
                <input type="hidden" class="gazelle-selected-variation" value="">
                <a href="#" 
                data-product_id="<?php echo esc_attr($product_id); ?>"
                class="btn btn-dark btn-modern text-uppercase bg-color-hover-primary 
                gazelle-add-to-cart border-color-hover-primary">Add to cart</a>
                <hr>
            </form>
        </div>
    </div>
