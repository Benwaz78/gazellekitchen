           ...
           <div class="row py-4">
                <div class="col-lg-6">
                    ...
                    <form class="contact-form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
                       ...
                       <input type="hidden" name="action" value="gk_contact_submit">
                        <?php wp_nonce_field('gk_contact_submit', 'gk_contact_nonce'); ?>
                       
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label class="form-label mb-1 text-2">Full Name</label>
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2" name="name" required="">
                            </div>
                            <div class="form-group col-lg-6">
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input type="text" value="" maxlength="100" class="form-control text-3 h-auto py-2" name="phone" required="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                                <label class="form-label mb-1 text-2">Message</label>
                                <textarea maxlength="5000"  rows="8" class="form-control text-3 h-auto py-2" name="message" ></textarea>
                            </div>
                        </div>
